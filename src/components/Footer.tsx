  ...
  const institucionalLinks = [
    {
      ...
      href: "https://www.fasuleducacional.edu.br/organizacao-administrativa",
      highlight: true,
    },
    ...
    { title: "Processos Seletivos", href: "https://www.fasuleducacional.edu.br/vestibularagendado" },
    {
      ...
      href: "https://www.fasuleducacional.edu.br/docs/REGIMENTO-INTERNO-E MANUAL-DO-ALUNO.pdf",
      external: true,
    },
    ...
    {
      title: "Extensão e Responsabilidade Social",
    ...
    {
      title: "Desenvolvimento Artístico e Cultural",
      href: "https://www.fasuleducacional.edu.br/desenvolvimento-artistico-cultural",
    },
    { title: "Revista Científica FASUL", href: "https://www.fasuleducacional.edu.br/revista" },
    {
      ...
      href: "https://www.fasuleducacional.edu.br/docs/Plano-de-Desenvolvimento-Institucional.pdf",
      external: true,
    },
  ];
    ...
    <footer className="footer-main rodapePadd">
              ...
              <ul className="p-0 text-left">
                {grupoLinks.map((link) => (
                  <li key={link.title} className="lirodape">
                    <a className="atxtrodape" href={link.href} title={link.title}>
                      {link.title}
                    </a>
                  </li>
                ))}
            ...
            <div className="w-full lg:w-1/4 p-0">
              ...
              <ul className="p-0 text-left">
                <li className="lirodape">
                  <a
                    ...
                    href="https://www.fasuleducacional.edu.br/cursos-graduacao-ead"
                    title="Graduação EAD"
                  >
                    Graduação EAD
                  </a>
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasulextensaouniversitaria.com.br/"
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Extensão Universitária EAD"
                  >
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/posgraduacao/categoria/mba"
                    title="MBA EAD"
                  >
                    MBA EAD
                  </a>
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasulcursosonline.com.br/"
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Cursos Profissionalizantes EAD"
                  >
              ...
              <ul className="p-0 text-left">
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/cursos-graduacao-presencial"
                    title="Graduação"
                  >
                    Graduação
                  </a>
              ...
              <ul className="p-0 text-left">
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/diploma"
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/diploma-historico"
                    title="Registro de Históricos"
                  >
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/tcc-repositorio"
                    title="Repositórios de TCC"
                  >
                    Repositórios de TCC
                  </a>
                </li>
            ...
            <div className="w-full lg:w-1/4 p-0">
              ...
              <ul className="p-0 text-left">
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/concursodebolsas"
              ...
              <ul className="p-0 text-left">
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/docs/Regulamento-das-Atividades-de-Extensao.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/docs/Regulamento-do-Programa-de-Iniciacao-Cientifica.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Regulamento do Programa de Iniciação Científica e Tecnológica"
                  >
                ...
                <li className="lirodape">
                  <a
                    ...
                    title="Regulamentos de Campanhas Promocionais"
                  >
                ...
                <li className="lirodape">
                  <a
                    className="atxtrodape"
                    href="https://www.fasuleducacional.edu.br/docs/regulamento-de-trancamento-de-matricula.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    title="REGULAMENTO DE TRANCAMENTO DE MATRÍCULA"
                  >
                    REGULAMENTO DE TRANCAMENTO DE MATRÍCULA
                  </a>
                </li>
              </ul>
              ...
              <div className="contact-channel-card__list">
                <div className="contact-channel-card__item contact-channel-card__item--call">
                  <div className="contact-channel-card__item-content">
                    ...
                    <a
                      className="flex contact-channel-card__phone contact-channel-card__phone--inline contact-channel-card__phone-link"
              ...
              <div className="contact-channel-card__list">
                <div className="contact-channel-card__item">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Abrir WhatsApp para tratar de matrícula e documentos"
                  >
                    <WhatsAppIcon className="text-white" />
                  </a>
                </div>
                <div className="contact-channel-card__item">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Abrir WhatsApp para apoio e sucesso acadêmico"
                  >
                    <WhatsAppIcon className="text-white" />
                  </a>
                </div>
                <div className="contact-channel-card__item">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Abrir WhatsApp para falar sobre boletos e acordos"
                  >
                    <WhatsAppIcon className="text-white" />
                  </a>
                </div>
      ...
      <div className="blue-background overflow-hidden">
        <div className="footer-container flex flex-row justify-between items-center gap-1 sm:gap-2 py-1 sm:py-2 !px-2 sm:!px-4 max-w-full overflow-hidden">
          <span className="txtDir text-[8px] sm:text-[13px] md:text-[15px] truncate">
            COPYRIGHT © 1997-2025 - FASUL. TODOS OS DIREITOS RESERVADOS.
          </span>
          <a
            className="txtPol text-[8px] sm:text-[13px] md:text-[15px] whitespace-nowrap flex-shrink-0"
